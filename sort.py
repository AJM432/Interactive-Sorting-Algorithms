...
settings_image = pygame.image.load("Settings.jpg").convert()
...
selection_sorting_image = pygame.image.load("selection_sorting.jpg").convert()
...
bubble_sort_image = pygame.image.load("Bubble_Sort.jpg").convert()
...
insertion_sort_image = pygame.image.load("Insertion_Sort.jpg").convert()
insertion_sort_image = pygame.transform.scale(insertion_sort_image, (WIDTH, int(HEIGHT/NUM_IMAGES)))
insertion_sort_image_pos = (0, int(HEIGHT/NUM_IMAGES*4))

cocktail_shaker_sort_image = pygame.image.load("Cocktail_Shaker_sort.jpg").convert()
cocktail_shaker_sort_image = pygame.transform.scale(cocktail_shaker_sort_image, (WIDTH, int(HEIGHT/NUM_IMAGES)))
cocktail_shaker_sort_image_pos = (0, int(HEIGHT/NUM_IMAGES*5))
